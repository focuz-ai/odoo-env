# Git guidelines — Odoo 16.0 (commits estilo Odoo)

> Fuente oficial: https://www.odoo.com/documentation/16.0/contributing/development/git_guidelines.html
>
...
| `[MIG]` | Migración de un módulo entre series Odoo (`[MIG] module: migration to 16.0`) |
...
- No commitees directo en `16.0` ni en `main`.
