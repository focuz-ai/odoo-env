# Convenciones y arquitectura — Odoo 16.0 EE

> Fuente oficial: https://www.odoo.com/documentation/16.0/contributing/development/coding_guidelines.html
...
- `version` con formato **`16.0.x.y.z`**.
